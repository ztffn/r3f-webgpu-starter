...
//   1. the elevation source for the terrain mesh builder (terrainGeometry.js), and
//   2. the seed of the Phase 3 gameplay/concealment heightfield
//      (04-concealment-system-design.md §1), which must be sampled independently
//      of whatever the GPU draws.
//
...
export class Heightfield {
  constructor({ seed = 1337 } = {}) {
    this.seed = seed;
    this.n = GRID_CELLS; // cells per side; (n+1)² samples
  ...
  // Written into `out` (a 3-element array) to avoid per-call allocation.
  // Using the field gradient (not mesh triangles) keeps lighting stable across
  // LOD levels (03-terrain-and-grass-rendering-design.md §2.4).
