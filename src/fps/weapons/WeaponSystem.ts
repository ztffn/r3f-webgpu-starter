...
export class WeaponSystem {
  ...
  constructor(definition: WeaponDefinition, instanceSeed = hashString32(definition.id)) {
    ...
    this.instanceSeed = Number.isFinite(instanceSeed) ? instanceSeed >>> 0 : hashString32(definition.id);
  }
